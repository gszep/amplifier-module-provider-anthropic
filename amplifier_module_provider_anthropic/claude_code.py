"""Claude Code provider module for Amplifier.
...
async def mount(coordinator: ModuleCoordinator, config: dict[str, Any] | None = None):
    """
    Mount the Claude Code provider.
    ...
    await coordinator.mount("providers", provider, name="claude-code")
    logger.info("Mounted ClaudeCodeProvider")
...
class ClaudeCodeProvider:
    ...
    def get_info(self) -> ProviderInfo:
        ...
        return ProviderInfo(
            id="claude-code",
            display_name="Claude Code (Max Subscription)",
            ...
            config_fields=[
                ...
                ConfigField(
                    ...
                    field_type="number",
                    prompt="Maximum agentic turns per request",
                    default="1",
                ),
                ConfigField(
                    id="permission_mode",
